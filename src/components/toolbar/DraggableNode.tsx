...
export const DraggableNode: React.FC<{
  ...
  return (
    <div
      className="
        group cursor-grab min-w-[72px] h-16 flex items-center justify-center flex-col 
        rounded-lg bg-white text-gray-900 px-3 select-none border border-gray-200 
        shadow-sm hover:shadow-md transition-shadow transition-colors 
